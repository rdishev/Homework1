...
public class GoodsController {
	...
	@RequestMapping(value="/goods/warehouse/{warehouse}", method = RequestMethod.GET)
	public ResponseEntity<List<Goods>> findByWarehouse (@PathVariable Warehouse warehouse){
		if(warehouse == null) {
			return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
		}
		List<Goods> goods = goodsRepository.findByWarehouse(warehouse);
		return new ResponseEntity<>(goods, HttpStatus.OK);
	}
